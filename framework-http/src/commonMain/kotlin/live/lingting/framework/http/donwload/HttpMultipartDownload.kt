package live.lingting.framework.http.donwload
...
import live.lingting.framework.io.multipart.MemoryMultipartSink
...
import live.lingting.framework.multipart.task.SinkMultipartTask
...
open class HttpMultipartDownload : SinkMultipartTask {
    ...
    class Builder {
        ...
        suspend fun build(): live.lingting.framework.http.donwload.HttpMultipartDownload {
        ...
        fun build(size: DataSize): live.lingting.framework.http.donwload.HttpMultipartDownload {
            val targetUrl = requireNotNull(url) { "URL 不能为空" }
