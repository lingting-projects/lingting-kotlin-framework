...
object HttpHeadersUtils {
    ...
    @JvmStatic
    fun HeadersBuilder?.to(): live.lingting.framework.http.header.HttpHeaders {
    ...
    @JvmStatic
    fun HeadersBuilder.appendAll(source: live.lingting.framework.http.header.HttpHeaders) {
        source.forEach { name, vs ->
            appendAll(name, vs)
        }
    }

    fun HeadersBuilder.setAll(source: live.lingting.framework.http.header.HttpHeaders) {
        source.forEach { name, vs ->
    ...
    @JvmStatic
    fun Headers?.to(): live.lingting.framework.http.header.HttpHeaders {
